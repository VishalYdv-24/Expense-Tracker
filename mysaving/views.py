...
def mysaving_home(request):
    ...
    return render(request, 'mysaving/home.html', {
        'expense': expense,
        'income': income,
...
def mysaving_expense(request):
    if request.method == "POST":
        form = ExpenseForm(request.POST)
        if form.is_valid():
            form.save()
            return redirect('mysaving:mysaving_home')
        else:
            print(form.errors)   # 👈 ADD THIS

    form = ExpenseForm()
    return render(request, 'mysaving/addExpense.html', {'form': form})


def mysaving_income(request):
    if request.method == "POST":
    ...
    form = IncomeForm()
    return render(request, 'mysaving/addIncome.html', {'form': form})
...
def expenseView(request,id):
    ...
    return render(request,'mysaving/expenseView.html',context)
...
def incomeView(request,id):
    ...
    return render(request,'mysaving/incomeView.html',context)
...
def expenseEdit(request,id):
    ...
    return render(request,'mysaving/addexpense.html',context)
...
def incomeEdit(request,id):
    ...
    return render(request,'mysaving/addincome.html',context)
